<x-app-layout>
    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route('damage_reports.update', $damageReport->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('variety') is-invalid @enderror" id="variety"
                        name="variety" value="{{ old('variety', $damageReport->variety) }}" required>
                </div>
                @error('variety')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                ...
                <div class="input-group">
                    ...
                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"
                        ...
                        <option value="Vegetables"
                            {{ old('type', $damageReport->type) == 'Vegetables' ? 'selected' : '' }}>
                            Vegetables</option>
                        <option value="Fruits" {{ old('type', $damageReport->type) == 'Fruits' ? 'selected' : '' }}>
                            Fruits
                        </option>
                        <option value="Rice" {{ old('type', $damageReport->type) == 'Rice' ? 'selected' : '' }}>Rice
                        </option>
                    </select>
                </div>
                @error('type')
                ...
                <div class="input-group">
                    ...
                    <select class="form-select @error('damage_type') is-invalid @enderror" id="damageType"
                        ...
                        <option value="Natural Disaster"
                            {{ old('damage_type', $damageReport->damage_type) == 'Natural Disaster' ? 'selected' : '' }}>
                            Natural Disaster</option>
                        <option value="Pest"
                            {{ old('damage_type', $damageReport->damage_type) == 'Pest' ? 'selected' : '' }}>Pest
                        </option>
                        <option value="Disease"
                            {{ old('damage_type', $damageReport->damage_type) == 'Disease' ? 'selected' : '' }}>Disease
                        </option>
                    </select>
                </div>
                @error('damage_type')
            ...
            <div class="mb-3" id="naturalDisasterTypeContainer" style="display: none;">
                ...
                <div class="input-group">
                    ...
                    <select class="form-select @error('natural_disaster_type') is-invalid @enderror"
                        ...
                        <option value="Flood"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Flood' ? 'selected' : '' }}>
                            Flood</option>
                        <option value="Typhoon"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Typhoon' ? 'selected' : '' }}>
                            Typhoon</option>
                        <option value="Drought"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Drought' ? 'selected' : '' }}>
                            Drought</option>
                        <option value="Earthquake"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Earthquake' ? 'selected' : '' }}>
                            Earthquake</option>
                        <option value="Volcanic Eruption"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Volcanic Eruption' ? 'selected' : '' }}>
                            Volcanic Eruption</option>
                        <option value="Landslide"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Landslide' ? 'selected' : '' }}>
                            Landslide</option>
                        <option value="Other"
                            {{ old('natural_disaster_type', $damageReport->natural_disaster_type) == 'Other' ? 'selected' : '' }}>
                            Other</option>
                    </select>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('damage_name') is-invalid @enderror"
                        id="damageName" name="damage_name"
                        value="{{ old('damage_name', $damageReport->damage_name) }}">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01"
                        ...
                        name="area_planted" value="{{ old('area_planted', $damageReport->area_planted) }}" required>
                </div>
                @error('area_planted')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01"
                        ...
                        name="area_affected" value="{{ old('area_affected', $damageReport->area_affected) }}"
                        required>
                </div>
                @error('area_affected')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="month" class="form-control @error('monthObserved') is-invalid @enderror"
                        ...
                        value="{{ old('monthObserved', $damageReport->monthObserved) }}" required>
                </div>
                @error('monthObserved')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
