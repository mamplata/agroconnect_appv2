...
<body>
        ...
        <div class="row">
            <div class="chart-container">
                <div class="chart-wrapper">
                    <!-- Full-width bar chart for disaster damage statistics -->
                    <div class="col-lg-12 mb-4">
                        <h2 class="text-center">Disaster Damage Statistics</h2>
                        <canvas id="disastersChart"></canvas>
                    </div>
                </div>
            </div>
            <div class="chart-container">
                <div class="chart-wrapper">
                    <!-- Smaller pie chart for disaster type by area affected -->
                    <div class="col-lg-5 col-md-6 col-sm-12 mb-4">
                        <h2 class="text-center">Disaster Type By Area Affected</h2>
                        <canvas id="disastersPieChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const ctx = document.getElementById('disastersChart').getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
        ...
        const pieCtx = document.getElementById('disastersPieChart').getContext('2d');
        new Chart(pieCtx, {
            type: 'pie',
            data: {
