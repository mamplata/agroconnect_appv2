...
<body>
    ...
    <div class="container
        ...
        <ul class="nav nav-pills justify-content-center mb-4" id="damageTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ request()->is('damages/pests') ? 'active bg-success text-white' : 'bg-light' }}"
                    href="{{ route('damages.pests') }}" role="tab">
                    <i class="fas fa-bug me-2"></i> Pests
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ request()->is('damages/diseases') ? 'active bg-warning text-dark' : 'bg-light' }}"
                    href="{{ route('damages.diseases') }}" role="tab">
                    <i class="fas fa-virus me-2"></i> Diseases
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link {{ request()->is('damages/natural-disaster') ? 'active bg-danger text-white' : 'bg-light' }}"
        ...
        <div class="row">
            <div class="chart-container">
                <div class="chart-wrapper">
                    ...
                    <div class="col-lg-12 mb-4">
                        <h2 class="text-center">Pest Damage Statistics</h2>
            ...
            <div class="chart-container">
                <div class="chart-wrapper">
                    <!-- Smaller pie chart for pest type by area affected -->
                    <div class="col-lg-5 col-md-6 col-sm-12 mb-4">
                        <h2 class="text-center">Pest Type By Area Affected</h2>
                        <canvas id="pestsPieChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const ctx = document.getElementById('pestsChart').getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
        ...
        const pieCtx = document.getElementById('pestsPieChart').getContext('2d');
        new Chart(pieCtx, {
            type: 'pie',
            data: {
